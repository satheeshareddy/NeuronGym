...
public class DualFocusProGame extends Activity implements View.OnClickListener {
    ...
    private ImageView image, image1, image2, image3, image4, image5, image6, image7, image8, image9, image10, image11, image12, image13, image14, image15, image16, image17, image18, image19, image20, image21, image22, image23, image24, image25, image26, image27, image28, image29, image30, image31, image32;
    ...
    private int digit, imageval, showimageval;
    ...
    private LinearLayout layoute0, layoute1, layoute2, layoute3, layoute4, layoute5, layoute6, layoute7,
            layoute8, layoute9, imagelayout1, imagelayout2, imagelayout3, imagelayout4,
            rightanswer, wronganswerval;
    private ImageView rightans, wrongans;
    private RefrenceWrapper refrence;
    private boolean rightlowerimage = false, rightimage = false, truedigit = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dual_focus_pro_game);

        ((RelativeLayout)findViewById(R.id.dualfocusprogame)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.dualfocusprogame)).setBackgroundResource(R.color.black);
        }
        ...
        imagelayout1 = (LinearLayout) findViewById(R.id.btnlayout1);
        imagelayout2 = (LinearLayout) findViewById(R.id.btnlayout2);
        imagelayout3 = (LinearLayout) findViewById(R.id.btnlayout3);
        imagelayout4 = (LinearLayout) findViewById(R.id.btnlayout4);


        imagelayout1.setOnClickListener(btnlistner);
        imagelayout2.setOnClickListener(btnlistner);
        imagelayout3.setOnClickListener(btnlistner);
        imagelayout4.setOnClickListener(btnlistner);
    ...
    private void gamestart() {
        resetbtn();
        truedigit = false;
        scoretext.setText("" + refrence.getDualfocuspro());
    ...
    View.OnClickListener btnlistner = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Log.e("imagevalue", "" + showimageval);
            if (v.getId() == R.id.btnlayout1) {
                if (showimageval == 0) {
                    imagelayout1.setBackgroundResource(R.drawable.cyan);
                    rightlowerimage = true;
                    rightanswer();
                } else {
                    wronganswer();
                }
            } else if (v.getId() == R.id.btnlayout2) {
                if (showimageval == 1) {
                    imagelayout2.setBackgroundResource(R.drawable.cyan);
                    rightlowerimage = true;
                    rightanswer();
                } else {
                    wronganswer();
                }
            } else if (v.getId() == R.id.btnlayout3) {
                if (showimageval == 2) {
                    imagelayout3.setBackgroundResource(R.drawable.cyan);
                    rightlowerimage = true;
                    rightanswer();
                } else {
                    wronganswer();
                }
            } else if (v.getId() == R.id.btnlayout4) {
                if (showimageval == 3) {
                    imagelayout4.setBackgroundResource(R.drawable.cyan);
                    rightlowerimage = true;
                    rightanswer();
                } else {
                    wronganswer();
    ...
    private void resetbtn() {
        ...
        imagelayout1.setBackgroundResource(R.drawable.grey);
        imagelayout2.setBackgroundResource(R.drawable.grey);
        imagelayout3.setBackgroundResource(R.drawable.grey);
        imagelayout4.setBackgroundResource(R.drawable.grey);
    ...
    private void rightanswer() {
        if (rightlowerimage && rightimage && truedigit) {
            if (rightanswer.getVisibility() == View.GONE) {
                ...
                scal.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationStart(Animation animation) {
                        refrence.setDualfocuspro(refrence.getDualfocuspro()+(multiplierval*100));
                       process();
                    }
    ...
    private void gameover() {
        refrence.setGame("DualFocusPro");
        refrence.setScore(refrence.getDualfocuspro());
