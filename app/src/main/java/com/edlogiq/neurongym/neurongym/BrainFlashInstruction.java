...
import com.edlogiq.neurongym.howtoplay.HowToPlayBrainFlash;
import com.edlogiq.neurongym.R;


public class BrainFlashInstruction extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brain_flash_instruction);

        ((RelativeLayout)findViewById(R.id.brainflashinstruction)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.brainflashinstruction)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.brain_flash);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_brain_flash);
        }
        ((TextView)findViewById(R.id.highesttextscore)).setText(""+ DataBase.getBrainFlash(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+DataBase.getBrainFlashM(this));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlayBrainFlash.class);
            startActivity(intent);
        }else if( v.getId() == R.id.startarrow){
            this.finish();
            Intent intent = new Intent(this, DualFocusInstruction.class);
            startActivity(intent);
            overridePendingTransition(R.anim.push_right_in, R.anim.push_right_out);
        }else if( v.getId() == R.id.howtoplayarrow){
            this.finish();
            Intent intent = new Intent(this, SpotItProInstruction.class);
            startActivity(intent);
            overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
        }else if(v.getId()==R.id.icone){
            BrainFlashInstruction.this.finish();
        }
