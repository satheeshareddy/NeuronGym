...
import com.edlogiq.neurongym.howtoplay.HowToPlayMemorymatrixPro;
import com.edlogiq.neurongym.R;


public class MemoryMatrixProInstruction extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memory_matrix_pro_instruction);


        ((RelativeLayout)findViewById(R.id.memorymatrixproinstruction)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.memorymatrixproinstruction)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.memory_matrix_pro);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_memory_matrix_pro);
        }

        ((TextView)findViewById(R.id.highesttextscore)).setText(""+ DataBase.getMemoryMatrixPro(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+ DataBase.getMemoryMatrixProM(this));
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlayMemorymatrixPro.class);
            startActivity(intent);
        }else if( v.getId() == R.id.startarrow){
            this.finish();
            Intent intent = new Intent(this, DancingBallInstruction.class);
            startActivity(intent);
            ...
            MemoryMatrixProInstruction.this.finish();
        }
