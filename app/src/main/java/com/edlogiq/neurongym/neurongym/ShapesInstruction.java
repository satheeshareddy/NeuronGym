...
import com.edlogiq.neurongym.howtoplay.HowToPlayShapes;
import com.edlogiq.neurongym.R;

public class ShapesInstruction extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shapes_instruction);

        ((RelativeLayout)findViewById(R.id.shapesinstruction)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.shapesinstruction)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.shapes);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_shapes);
        }
        ((TextView)findViewById(R.id.highesttextscore)).setText(""+ DataBase.getShapes(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+ DataBase.getShapesM(this));
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlayShapes.class);
            startActivity(intent);
