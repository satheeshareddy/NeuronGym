...
import com.edlogiq.neurongym.howtoplay.HowToPlaySolveIt;
import com.edlogiq.neurongym.R;


public class SolveItInstruction extends ActionBarActivity implements View.OnClickListener {
    private RatingBar ratingBar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_solve_it_instruction);

        ((RelativeLayout)findViewById(R.id.solveitinstruction)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.solveitinstruction)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.solve_it);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_solve_it);
        }

        ((TextView)findViewById(R.id.highesttextscore)).setText(""+ DataBase.getSolveIt(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+ DataBase.getSolveItM(this));
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlaySolveIt.class);
            startActivity(intent);
            ...
            SolveItInstruction.this.finish();
        }
