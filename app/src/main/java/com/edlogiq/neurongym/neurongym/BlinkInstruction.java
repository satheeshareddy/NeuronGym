...
import com.edlogiq.neurongym.howtoplay.HowToPlayBlink;
import com.edlogiq.neurongym.R;


public class BlinkInstruction extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blink_instruction);

        ((RelativeLayout)findViewById(R.id.blinkinstruction)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.blinkinstruction)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.blink);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_blink);
        }
        ((TextView)findViewById(R.id.highesttextscore)).setText(""+ DataBase.getBlink(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+DataBase.getBlinkM(this));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlayBlink.class);
            startActivity(intent);
