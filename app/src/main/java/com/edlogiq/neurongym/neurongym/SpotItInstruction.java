...
import com.edlogiq.neurongym.howtoplay.HowToPlaySpotIt;
import com.edlogiq.neurongym.R;


public class SpotItInstruction extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spot_it_instruction);

        ((RelativeLayout)findViewById(R.id.spotitinstruction)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.spotitinstruction)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.spot_it);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_spot_it);
        }

        ((TextView)findViewById(R.id.highesttextscore)).setText(""+ DataBase.getSpotIt(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+ DataBase.getSpotItM(this));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlaySpotIt.class);
            startActivity(intent);
            ...
            this.finish();
            Intent intent = new Intent(this, SpeedShopInstruction.class);
            startActivity(intent);
            overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
        }else if(v.getId()==R.id.icone){
            SpotItInstruction.this.finish();
        }
    }
}
