...
import com.edlogiq.neurongym.howtoplay.HowToPlaySpotItPro;
import com.edlogiq.neurongym.R;


public class SpotItProInstruction extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spot_it_pro_instruction);

        ((RelativeLayout)findViewById(R.id.spotitproinstruction)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.spotitproinstruction)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.spot_it_pro);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_spot_it_pro);
        }
        ((TextView)findViewById(R.id.highesttextscore)).setText(""+ DataBase.getSpotItPro(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+ DataBase.getSpotItProM(this));
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlaySpotItPro.class);
            startActivity(intent);
            ...
            SpotItProInstruction.this.finish();
        }
