...
import com.edlogiq.neurongym.howtoplay.HowToPlayAfterMatch;


public class AfterMathInstruction extends ActionBarActivity implements View.OnClickListener {

   private RatingBar ratingBar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_after_math_instruction);

        ((RelativeLayout)findViewById(R.id.aftermathinstrection)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.aftermathinstrection)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.after_math);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_after_math);
        }
        ((TextView)findViewById(R.id.highesttextscore)).setText(""+DataBase.getAfterMath(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+DataBase.getAfterMathM(this));
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlayAfterMatch.class);
            startActivity(intent);
        }else if( v.getId() == R.id.startarrow){
            AfterMathInstruction.this.finish();
