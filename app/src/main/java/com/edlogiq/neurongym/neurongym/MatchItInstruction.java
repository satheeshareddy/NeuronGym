...
import com.edlogiq.neurongym.howtoplay.HowToPlayMatchIt;
import com.edlogiq.neurongym.R;

public class MatchItInstruction extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_it_instruction);

        ((RelativeLayout)findViewById(R.id.matchitinstruction)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.matchitinstruction)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.match_it);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_match_it);
        }

        ((TextView)findViewById(R.id.highesttextscore)).setText(""+ DataBase.getMatchIt(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+ DataBase.getMatchItM(this));
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlayMatchIt.class);
            startActivity(intent);
            ...
            MatchItInstruction.this.finish();
        }
