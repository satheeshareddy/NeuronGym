...
public class DualFocusInstruction extends ActionBarActivity implements View.OnClickListener {

    RatingBar ratingBar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dual_focus_instruction);

        ((RelativeLayout)findViewById(R.id.dualfocusinstruction)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.dualfocusinstruction)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.dual_focus);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_dual_focus);
        }

        ((TextView)findViewById(R.id.highesttextscore)).setText(""+ DataBase.getDualFocus(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+ DataBase.getDualFocusM(this));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlayDualFocuse.class);
            startActivity(intent);
        }else if( v.getId() == R.id.startarrow){
            this.finish();
            Intent intent = new Intent(this, DualFocusProInstruction.class);
            startActivity(intent);
            overridePendingTransition(R.anim.push_right_in, R.anim.push_right_out);
        }else if( v.getId() == R.id.howtoplayarrow){
            this.finish();
            Intent intent = new Intent(this, BrainFlashInstruction.class);
            startActivity(intent);
            overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
        }else if(v.getId()==R.id.icone){
            DualFocusInstruction.this.finish();
        }
