...
import com.edlogiq.neurongym.howtoplay.HowToPlayReversalPro;
import com.edlogiq.neurongym.R;


public class ReversalProInstruction extends ActionBarActivity implements View.OnClickListener {
    private RatingBar ratingBar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_reversal_pro_instruction);


        ((RelativeLayout)findViewById(R.id.reversalproinstruction)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.reversalproinstruction)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.reversal_pro);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_reversal_pro);
        }

        ((TextView)findViewById(R.id.highesttextscore)).setText(""+ DataBase.getReversalPro(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+ DataBase.getReversalProM(this));
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlayReversalPro.class);
            startActivity(intent);
        }else if( v.getId() == R.id.startarrow){
            this.finish();
            Intent intent = new Intent(this, MoneyGameInstruction.class);
            startActivity(intent);
            overridePendingTransition(R.anim.push_right_in, R.anim.push_right_out);
        }else if( v.getId() == R.id.howtoplayarrow){
            this.finish();
            Intent intent = new Intent(this, ReversalInstruction.class);
            startActivity(intent);
            overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
        }else if(v.getId()==R.id.icone){
            ReversalProInstruction.this.finish();
        }
