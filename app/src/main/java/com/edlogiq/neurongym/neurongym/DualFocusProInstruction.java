...
import com.edlogiq.neurongym.howtoplay.HowToPlayDualFocuspro;
import com.edlogiq.neurongym.R;

public class DualFocusProInstruction extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dual_focus_pro_instruction);

        ((RelativeLayout)findViewById(R.id.dualfocusproinstruction)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.dualfocusproinstruction)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.dual_focus_pro);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_dual_focus_pro);
        }
        ((TextView)findViewById(R.id.highesttextscore)).setText(""+ DataBase.getDualFocusPro(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+ DataBase.getDualFocusProM(this));
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlayDualFocuspro.class);
            startActivity(intent);
            ...
            DualFocusProInstruction.this.finish();
        }
