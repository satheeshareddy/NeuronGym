...
import com.edlogiq.neurongym.howtoplay.HowToPlayMatchItPro;
import com.edlogiq.neurongym.R;


public class MatchItProInstruction extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_it_pro_instruction);


        ((RelativeLayout)findViewById(R.id.matchitproinstruction)).setBackgroundResource(R.color.white);
        if(DataBase.getTheam(this).equals("dark")){
            ((RelativeLayout)findViewById(R.id.matchitproinstruction)).setBackgroundResource(R.color.black);
        }
        ...
        if (nameoflayoute != null) {
            nameoflayoute.setText(R.string.match_it_pro);
        }
        ...
        if (slideimage != null) {
            slideimage.setBackgroundResource(R.drawable.sub_match_it_pro);
        }

        ((TextView)findViewById(R.id.highesttextscore)).setText(""+ DataBase.getMatchItPro(this));
        ((TextView)findViewById(R.id.textmuiltiplier)).setText(""+ DataBase.getMatchItProM(this));
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.starttextView ) {
            ...
            Intent intent = new Intent(this, HowToPlayMatchItPro.class);
            startActivity(intent);
            ...
            this.finish();
            Intent intent = new Intent(this, MatchItInstruction.class);
            startActivity(intent);
            overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
        }else if(v.getId()==R.id.icone){
            MatchItProInstruction.this.finish();
        }
